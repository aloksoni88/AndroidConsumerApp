...
public final class PropertySearchResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public PropertySearchResponse setCount(Integer count) {
    this.count = count;
    return this;
  }
   ...
   */
  public PropertySearchResponse setErrorId(Integer errorId) {
   ...
   */
  public PropertySearchResponse setErrorMessage(String errorMessage) {
   ...
   */
  public PropertySearchResponse setId(Long id) {
    this.id = id;
    return this;
  }
   ...
   */
  public PropertySearchResponse setRequestId(Long requestId) {
   ...
   */
  public PropertySearchResponse setStatus(Boolean status) {
    this.status = status;
    return this;
  }
