...
public final class SearchProperty extends com.google.api.client.json.GenericJson {
   ...
   */
  public SearchProperty setAddress(String address) {
   ...
   */
  public SearchProperty setArea(Integer area) {
    this.area = area;
    return this;
  }
   ...
   */
  public SearchProperty setBath(Integer bath) {
    this.bath = bath;
    return this;
  }
   ...
   */
  public SearchProperty setBed(Integer bed) {
    this.bed = bed;
    return this;
  }
   ...
   */
  public SearchProperty setBsp(Long bsp) {
    this.bsp = bsp;
    return this;
  }
   ...
   */
  public SearchProperty setBuilderId(Long builderId) {
   ...
   */
  public SearchProperty setBuilderName(String builderName) {
   ...
   */
  public SearchProperty setCityId(Long cityId) {
    this.cityId = cityId;
    return this;
  }
   ...
   */
  public SearchProperty setDriveView(Boolean driveView) {
   ...
   */
  public SearchProperty setDroneView(Boolean droneView) {
   ...
   */
  public SearchProperty setFurnished(String furnished) {
   ...
   */
  public SearchProperty setImage(String image) {
    this.image = image;
    return this;
  }
   ...
   */
  public SearchProperty setImageList(String imageList) {
   ...
   */
  public SearchProperty setImageResize(String imageResize) {
   ...
   */
  public SearchProperty setLat(Double lat) {
    this.lat = lat;
    return this;
  }
   ...
   */
  public SearchProperty setLng(Double lng) {
    this.lng = lng;
    return this;
  }
   ...
   */
  public SearchProperty setName(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public SearchProperty setOffer(Boolean offer) {
    this.offer = offer;
    return this;
  }
   ...
   */
  public SearchProperty setOurPicksScore(Integer ourPicksScore) {
   ...
   */
  public SearchProperty setPossession(Long possession) {
   ...
   */
  public SearchProperty setProject(Long project) {
   ...
   */
  public SearchProperty setProperty(Long property) {
   ...
   */
  public SearchProperty setSceoURL(String sceoURL) {
   ...
   */
  public SearchProperty setSoldStatus(Boolean soldStatus) {
   ...
   */
  public SearchProperty setSponsor(Integer sponsor) {
   ...
   */
  public SearchProperty setStatus(String status) {
    this.status = status;
    return this;
  }
   ...
   */
  public SearchProperty setType(String type) {
    this.type = type;
    return this;
  }
   ...
   */
  public SearchProperty setVirtualTour(Boolean virtualTour) {
