...
public final class AgentCheckInHistory extends com.google.api.client.json.GenericJson {
   ...
   */
  public AgentCheckInHistory setAgentName(String agentName) {
   ...
   */
  public AgentCheckInHistory setCheckIn(Boolean checkIn) {
   ...
   */
  public AgentCheckInHistory setLat(Double lat) {
    this.lat = lat;
    return this;
  }
   ...
   */
  public AgentCheckInHistory setLng(Double lng) {
    this.lng = lng;
    return this;
  }
   ...
   */
  public AgentCheckInHistory setManual(Boolean manual) {
    this.manual = manual;
    return this;
  }
   ...
   */
  public AgentCheckInHistory setProjectId(Long projectId) {
   ...
   */
  public AgentCheckInHistory setProjectName(String projectName) {
