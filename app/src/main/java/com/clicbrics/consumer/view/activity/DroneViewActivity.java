...
public class DroneViewActivity extends BaseActivity {
        ...
        try {
            ...
            videoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError(MediaPlayer mediaPlayer, int what, int extra) {
                    Log.i("DroneViewScreen", "@@@@@ onError @@@@@" + "what=" + what + " extra=" + extra);
                    dismissProgressBar();
                    return false;
                }
            });
                ...
                public void onPrepared(final MediaPlayer mediaPlayer) {
                    mediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() {
                        ...
                        public boolean onError(MediaPlayer mediaPlayer, int what, int extra) {
                            Log.i("DroneViewScreen", "onError: " + "what=" + what + " extra=" + extra);
                            dismissProgressBar();
                            if (!UtilityMethods.isInternetConnected(DroneViewActivity.this)) {
                                UtilityMethods.showErrorSnackbarOnTop(DroneViewActivity.this);
                            }
                            return false;
                        }
                    });
                    ...
                    mediaPlayer.setOnInfoListener(new MediaPlayer.OnInfoListener() {
                        ...
                        public boolean onInfo(MediaPlayer mediaPlayer, int what, int extra) {
                            Log.i("DroneViewScreen", "onInfo: " + "what=" + what + " extra=" + extra);
                    ...
                    mediaPlayer.setOnBufferingUpdateListener(new MediaPlayer.OnBufferingUpdateListener() {
                        ...
                        public void onBufferingUpdate(MediaPlayer mediaPlayer, int percent) {
                            Log.i("DriveViewScreen", "***** onBufferingUpdate called ********** " + percent);
                        }
                    });
