...
package com.clicbrics.consumer.customview.roundedimageview;
...
public class RoundedImageView extends ImageView {
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    scaled = a.getBoolean(R.styleable.RoundedImageView_scaled, false);
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if(scaled) {
      int ratioWidth = (int) (UtilityMethods.getScreenWidth(getContext()) * (0.8f));

      setMeasuredDimension((int) (UtilityMethods.getScreenWidth(getContext()) * (0.8f)),
              (int) (UtilityMethods.getScreenWidth(getContext()) * 0.50f));
    }
  }
