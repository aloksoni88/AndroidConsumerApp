...
class SnackbarManager {
    ...
    private static com.clicbrics.consumer.topsnackbar.SnackbarManager sSnackbarManager;

    static com.clicbrics.consumer.topsnackbar.SnackbarManager getInstance() {
        if (sSnackbarManager == null) {
            sSnackbarManager = new com.clicbrics.consumer.topsnackbar.SnackbarManager();
        }
