...
public class UsedLibraryActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_used_library);
        ...
        WebView webView = (WebView) findViewById(R.id.usedLibraryWebview);
//        webView.loadUrl("file:///android_asset/TERMSANDCONDITIONS.html");
        webView.loadUrl(Constants.AppConstants.USED_LIBRARY_URL);
    ...
    protected void onStop() {
        super.onStop();
        new EventAnalyticsHelper().logUsageStatsEvents(this,onStartTime,System.currentTimeMillis(),Constants.AnaylticsClassName.UsedLibraryActivityScreen);

      /*  TrackAnalytics.trackEvent("UsedLibraryActivity", Constants.AppConstants.HOLD_TIME,
