...
public class AboutUsViewActivity extends BaseActivity {

    private static final String TAG = AboutUsViewActivity.class.getSimpleName();
    @Override
...
//        webView.loadUrl("file:///android_asset/TERMSANDCONDITIONS.html");
        webView.loadUrl(Constants.AppConstants.ABOUT_US_URL);
    ...
    protected void onStop() {
        super.onStop();
        new EventAnalyticsHelper().logUsageStatsEvents(this,onStartTime,System.currentTimeMillis(),Constants.AnaylticsClassName.AboutUsViewActivity);

       /* TrackAnalytics.trackEvent("AboutUsViewActivity", Constants.AppConstants.HOLD_TIME,
