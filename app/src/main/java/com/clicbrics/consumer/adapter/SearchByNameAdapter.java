...
public class SearchByNameAdapter extends RecyclerView.Adapter<SearchByNameAdapter.MyViewHolder> implements Filterable {
    Activity mActivity;
    ArrayList<ProjectsByname> projectsBynames;
    GeoDataClient geoDataClient;
    public SearchByNameAdapter(Activity mActivity, ArrayList<ProjectsByname> projectsBynames, GeoDataClient geoDataClient) {
...
//        holder.address_detail.setText(projectsBynames.get(position).getName());
        ...
        holder.address_detail.setText(projectsBynames.get(position).getAddresss());
        holder.type.setText(projectsBynames.get(position).getType());
        holder.imageView.setVisibility(View.GONE);
        holder.address_detail.setVisibility(View.VISIBLE);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    data.putExtra("lng", String.valueOf(mResultList.get(position).longitude));*/
                        ...
                        mActivity.finish();
                        selected_type=Constants.EventClickName.SelectDeveloper.toString();
                        addToRecentSearches(primartyText, secondaryText,
                                ...
                                projectsBynames.get(getAdapterPosition()).getName(),cityId, /*cityName*/projectsBynames.get(getAdapterPosition()).getAddresss());
                    }
                   else if(projectsBynames.get(getAdapterPosition()).getType().equalsIgnoreCase("Project"))
                    {
                       ...
                       /* if(mResultList.get(position).cityId != 0) {
                        ...
                        addToRecentSearches(primartyText, secondaryText,
                                ...
                                "",cityId,
                                /*cityName*/projectsBynames.get(getAdapterPosition()).getAddresss());
                        selected_type=Constants.EventClickName.SelectProject.toString();
                    }
                  else  if(projectsBynames.get(getAdapterPosition()).getType().equalsIgnoreCase("Locality"))
                    {

                        selected_type=Constants.EventClickName.SelectLocality.toString();
                    ...
                    new EventAnalyticsHelper().ItemClickEvent(mActivity, Constants.AnaylticsClassName.SearchScreen,
                            projectsBynames.get(getAdapterPosition()), Constants.AnalyticsEvents.ON_CLICK_ACTION,selected_type);
